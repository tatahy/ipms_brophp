...
function switchmenu(menutitle, menulist, num){	
	...
	switch(num){
		case 0: mTitleObj.textContent="——专利管理——"; break;//IE中的获取文本方法是innerText，在firefox中不支持，firefox改成了textContent方法/属性;chrome两个都支持
		case 1: mTitleObj.textContent="——论文管理——"; break;//IE中的获取文本方法是innerText，在firefox中不支持，firefox改成了textContent方法/属性;chrome两个都支持
		case 2: mTitleObj.textContent="——成果管理——"; break;//IE中的获取文本方法是innerText，在firefox中不支持，firefox改成了textContent方法/属性;chrome两个都支持
        case 3: mTitleObj.textContent="——奖项管理——"; break;//IE中的获取文本方法是innerText，在firefox中不支持，firefox改成了textContent方法/属性;chrome两个都支持
	}
...
//多选框处理，全选、反选、全不选
	var checkall=document.getElementsByName("userid[]");
