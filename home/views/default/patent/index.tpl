    ...
    <div id="main">
        ...
        <div class="head-dark-box">
            <{if $smarty.session.groupname eq "超级管理员" or $smarty.session.groupname eq "批准人" or $smarty.session.groupname eq "维护人"}>
                <div class="tit"><span class="red_font">研究院专利</span> —— 总表</div>
            <{elseif $smarty.session.groupname eq "审核人" or $smarty.session.groupname eq "撰写人"}>
                <div class="tit"><span class="red_font">部门专利</span> —— 总表</div>
            <{else}>
				...
				<div class="mar">
                    <ul class="viewmess">
                    	<li class="dark-row">
                            ...
                            <span class="list_width width_font" style="width:100px"><a href="<{$app}>/patent/index/str/pattype">类&nbsp;&nbsp;型^</a></span>
                            <span class="list_width width_font" style="width:80px"><a href="<{$app}>/patent/index/str/status">状&nbsp;&nbsp;态^</a></span>
                            <span class="list_width width_font" style="width:80px"><a href="<{$app}>/patent/index/str/writer">撰写人^</a></span>
        					<span class="list_width width_font" style="width:100px"><a href="<{$app}>/patent/index/str/dept">部门名称^</a></span>
                            <span class="list_width width_font" style="width:100px"><a href="<{$app}>/patent/index/str/adddate">填报日期^</a></span>
