...
<body style="background:white;margin:1px;">
    <div id="main">
        <div class="head-dark-box">
            <div class="tit"><span class="red_font">专利</span>&nbsp;--&nbsp;<{$patent.pattopic}>&nbsp;--&nbsp;的附件处理 ->【附件上传】</div>
        ...
        <form  method="post" action="<{$url}>/upfile" enctype="multipart/form-data">
			 ...
			 <div class="msg-box">
				<ul class="viewmess">
                    ...
                    <input type="hidden" name="pat_id" value="<{$pat_id}>"><br>
                    <input type="hidden" name="cstatus" value="<{$patent.status}>"><br>
                    <input type="hidden" name="attachment" value="<{$patent.attachment}>" style="width:300px"><br>
                    ...
                    <{ if $groupname eq '撰写人'}>
                        ...
                        <input type="submit" value="返 回" formaction="<{$app}>/patent/my_patlist/cstatus/<{$patent.status}>"/>&nbsp;&nbsp; 
