<{ include file="public/header.tpl" }>
	...
	<div id="main">
        ...
        <div class="head-dark-box">
				<div class="tit"><span class="red_font">发表论文列表</span></div>
        </div>
				...
				<div class="mar">
                    <ul class="viewmess">
                    	<li class="dark-row">
                            ...
                            <span class="list_width width_font" style="width:100px">第一作者</span>
                        ...
                        <{ section name=doc_the loop=$sets_the }>
        						<li class="<{if $smarty.section.doc_the.index is even}>light-row<{else}>dark-row<{/if}>" style="padding-top:5px; padding-bottom:5px">
        							...
        							<span class="list_width" style="width:100px"><{ $sets_the[doc_the].author1st}></span>
