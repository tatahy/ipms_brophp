    ...
    <div id="main">
        ...
        <div class="head-dark-box">
            <{if $smarty.session.groupname eq "超级管理员" or $smarty.session.groupname eq "批准人" or $smarty.session.groupname eq "维护人"}>
                <div class="tit"><span class="red_font">研究院论文</span> ——【<span class="red_font"><{$cstatus}></span>】状态</div>
            <{elseif $smarty.session.groupname eq "审核人" or $smarty.session.groupname eq "撰写人"}>
           	    <div class="tit"><span class="red_font">部门论文</span> ——【<span class="red_font"><{$cstatus}></span>】状态</div>
            <{else}>
