...
<body style="background:white;margin:1px;">
 ...
 <{/block}>                    
                    ...
                    <li class="light-row">
                        ...
                        *}>
						<input class="col_width2 text-box-readonly" name="uid" type="hidden"  value="<{ $thesis.uid }>" readonly="readonly"/>
                    ...
                    <{block name="status"}>
                        ...
                        <{else }>
                            <span class="col_width">论文状态&nbsp;<span class="red_font">*</span></span>
                            <input class="col_width2 text-box-readonly" name="status" value="<{ $thesis.status }>" readonly="readonly" />
            ...
            <{*由定义的$t_status变量根据thesis.class.php的operate_status操作传递的$thesis['status']输入框的标题*}>
                    ...
                    <{block name="maintain_2"}>
                        <{if $t_status eq "投稿" }>
                            ...
                            <input class="col_width2 text-box-readonly" name="cntrdate" type="date"  value="<{ $thesis.cntrdate }>" readonly="readonly"/>
                        ...
                        <{elseif ($t_status eq "收录")}>
                            ...
                            <input class="col_width2 text-box-readonly" name="incl_rejdate" type="date"  value="<{ $thesis.incl_rejdate }>" readonly="readonly"/>
                        ...
                        <{elseif $t_status eq "出版" }>
    						...
    						<input class="col_width2 text-box-readonly" name="pubdate" type="date"  value="<{ $thesis.pubdate }>" readonly="readonly"/>
                    ...
                    <li class="light-row"> 
                        ...
                        <{if $t_status eq "填报" or $t_status eq "修改"}>
    						...
    						<input class="col_width4" name="dept" type="text"  value="<{ $thesis.dept }>" class="text-box"/>
                        ...
                        *}>
                        ...
                        <span class="col_width">所属部门&nbsp;<span class="red_font">*</span></span> 
						<input class="col_width4 text-box-readonly" name="dept" type="text"  value="<{ $thesis.dept }>" class="text-box" readonly="readonly"/><{*就为uid的dept值*}>                        
