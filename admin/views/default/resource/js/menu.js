...
function switchmenu(menutitle, menulist, num){	
	...
	switch(num){
		case 0: mTitleObj.textContent="【系统管理】"; break;//IE中的获取文本方法是innerText，在firefox中不支持，firefox改成了textContent方法/属性;chrome两个都支持
		case 1: mTitleObj.textContent="【内容管理】"; break;//IE中的获取文本方法是innerText，在firefox中不支持，firefox改成了textContent方法/属性;chrome两个都支持
		case 2: mTitleObj.textContent="【用户管理】"; break;//IE中的获取文本方法是innerText，在firefox中不支持，firefox改成了textContent方法/属性;chrome两个都支持
	}
