			...
			<div class="msg-box">
				<ul class="viewmess">
					...
					<li class="dark-row">
						...
						<input name="userpwd" type="password"  value="<{if $post.srcpwd eq null}>123456<{else}><{$post.srcpwd}><{/if}>" class="text-box"> 
						初使密码为123456
					</li>
					<li class="light-row">
						<span class="col_width">确认密码<span class="red_font">*</span></span>
						<input name="repwd" type="password"  value="<{if $post.srcpwd eq null}>123456<{else}><{$post.srcpwd}><{/if}>"  size="20" class="text-box">
					</li>
                    ...
                    <li class="dark-row">
						<span class="col_width">部门名称<span class="red_font">*</span></span>
						<input name="dept" type="text"  value="<{ $post.dept }>" class="text-box">
						请正确添写你的工作部门名称
					</li> 	
